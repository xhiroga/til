...
def quadrafic_case(func_ax: plt.Axes, derived_ax: plt.Axes):
    ...
    # 接線
    tangent_at_x_equal_2 = x * derived_function_of_function_x(2) - 4
    func_ax.plot(x, tangent_at_x_equal_2, color='red')

    tangent_at_x_equal_3 = x * derived_function_of_function_x(3) - 9
    func_ax.plot(x, tangent_at_x_equal_3, color='red')

    tangent_at_x_equal_4 = x * derived_function_of_function_x(4) - 16
