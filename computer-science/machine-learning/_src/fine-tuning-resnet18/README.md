# [Fine-Tuning a Pre-Trained ResNet-18 Model for Image Classification with PyTorch | Alireza Samar](https://alirezasamar.com/posts/fine-tuning-pre-trained-resnet-18-model-image-classification-pytorch/)
